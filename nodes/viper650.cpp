...
RosViper650Node::RosViper650Node( ros::NodeHandle nh )
{
  ...
  if ( setControlMode == "joint_space" )
  {
    ...
    cmd_jointvel_sub = n.subscribe( cmdVelTopicName, 1,
                                    (boost::function< void( const sensor_msgs::JointStateConstPtr & ) >)boost::bind(
                                        &RosViper650Node::setJointVel, this, _1 ) );
  }
  else if ( setControlMode == "camera_frame" )
  {
    ...
    cmd_camvel_sub = n.subscribe( cmdVelTopicName, 1,
                                  (boost::function< void( const geometry_msgs::TwistStampedConstPtr & ) >)boost::bind(
                                      &RosViper650Node::setCameraVel, this, _1 ) );
  }
  else if ( setControlMode == "reference_frame" )
  {
    ...
    cmd_refvel_sub = n.subscribe( cmdVelTopicName, 1,
                                  (boost::function< void( const geometry_msgs::TwistStampedConstPtr & ) >)boost::bind(
                                      &RosViper650Node::setRefVel, this, _1 ) );
  }
}
...
RosViper650Node::setup()
{
  ...
  else if ( endEffectorType == "TOOL_CUSTOM" )
  {
    ...
    {
      ROS_ERROR_STREAM( "Viper650: Cannot load eMt custom tool transformation from \""
...
RosViper650Node::setCameraVel( const geometry_msgs::TwistStampedConstPtr &msg )
{
  ...
  ROS_INFO( "Viper650 new camera vel at %f s: [%0.2f %0.2f %0.2f] m/s [%0.2f %0.2f %0.2f] rad/s", veltime.toSec(),
...
RosViper650Node::setJointVel( const sensor_msgs::JointStateConstPtr &msg )
{
  ...
  ROS_INFO( "Viper650 new joint vel at %f s: [%0.2f %0.2f %0.2f %0.2f %0.2f %0.2f] rad/s", veltime.toSec(), qdot[0],
...
RosViper650Node::setRefVel( const geometry_msgs::TwistStampedConstPtr &msg )
{
  ...
  ROS_INFO( "Viper650 new reference vel at %f s: [%0.2f %0.2f %0.2f] m/s [%0.2f %0.2f %0.2f] rad/s", veltime.toSec(),
